...
(function () {
  const bundle = {
    ...
    "settings.section.overlay": "Stream-Seiten-Overlay",
    "settings.overlay.collapsed_default": "Standardmäßig zugeklappt",
    "settings.overlay.hint": "Steuert nur den Anfangszustand auf neuen Tabs/Seiten. Wenn du den Overlay manuell auf- oder zuklappst, merkt sich die Extension das pro Browser separat.",
