...
(function () {
  const bundle = {
    ...
    "settings.section.overlay": "Stream-page overlay",
    "settings.overlay.collapsed_default": "Collapsed by default",
    "settings.overlay.hint": "Only controls the initial state on new tabs/pages. Manually expanding or collapsing the overlay still sticks per browser.",
